                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endphp
                                <span class="badge {{ $badgeClasses[$payment->status] ?? 'bg-secondary' }} fs-6 fw-semibold">
                            ...
                            <td class="text-center d-flex gap-2 justify-content-center">
                                <a href="{{ route('admin.payments.show', $payment->id) }}"
                                    class="btn btn-sm btn-success d-flex align-items-center justify-content-center gap-1" style="width: 120px; padding: 10px;">
                                ...
                                <a href="{{ route('admin.payments.edit', $payment->id) }}"
                                    class="btn btn-sm btn-primary d-flex align-items-center justify-content-center gap-1" style="width: 120px; padding: 10px;">
