            ...
            <div class="card border-0 shadow-sm rounded">
                <div class="card-body">
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.products.create') }}" class="btn btn-md btn-success mb-3 py-2">+ ADD PRODUCT</a>
                    </div>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                            ...
                                            <a href="{{ route('admin.products.show', $product->id) }}"
                                                class="btn btn-sm btn-success d-flex align-items-center justify-content-center gap-1" style="width: 160px; padding: 10px;">
