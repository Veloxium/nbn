            ...
            card.addEventListener('click', function() {
                ...
                fetch(`/product/${productId}`)
                    ...
                    .then(product => {
                        ...
                        document.getElementById('modalProductDescription').textContent = product.full_description;
                        document.getElementById('modalProductId').value = product.id;

                        // Update gambar di carousel
                        let carouselInner = document.querySelector('#productCarousel .carousel-inner');
