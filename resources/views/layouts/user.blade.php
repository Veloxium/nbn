...
<head>
    ...
    <style>
        ...
        .navbar-nav.center-nav {
            display: flex;
            justify-content: center; /* Menyebarkan item navbar ke tengah */
            flex-grow: 1; /* Membuat navbar membesar agar posisi menu di tengah */
        }
        ...
        .nav-link:hover {
            background-color: #f0f0f0; /* Efek hover saat cursor di atas item */
        }

        .card-text {
        text-align: justify; /* Justify deskripsi produk */
    }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('home') }}">NBN</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav center-nav">
                    ...
                    <li class="nav-item">
                    <a class="nav-link @if(request()->routeIs('home')) active @endif" href="#new-products">Products</a>
                    </li>
                    <li class="nav-item">
